...
# adds custom theme
sudo find /home/$SUDO_USER/Downloads/OC_suite/Blender_mod/Startup -name 'userpref.blend' -exec cp -f /home/$SUDO_USER/.config/blender/$BVERSION/config {} +
sudo find /home/$SUDO_USER/Downloads/OC_suite/Blender_mod/blenderTheme -name '.xml' -exec cp -f /home/$SUDO_USER/.config/blender/$BVERSION/scripts/interface_theme {} +

# adds custom startup file
sudo find /home/$SUDO_USER/Downloads/OC_suite/Blender_mod/Startup -name 'startup.blend' -exec cp -f /home/$SUDO_USER/.config/blender/$BVERSION/config {} +

# adds MaiaDark theme to Krita
sudo find /home/$SUDO_USER/Downloads/OC_suite/Krita_mod -name 'kritarc' -exec cp -f /home/$SUDO_USER/.config {} +
sudo find /home/$SUDO_USER/Downloads/OC_suite/Krita_mod -name 'MaiaDark.colors' -exec cp -f /usr/share/color-schemes {} +
